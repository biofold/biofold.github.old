...
def main():
    ...
    ipinfo_db_api_key = '9937ce8e8d46ada2eca176384dbd3ddb0b10fce3db7c245300456fc2d8148eaa'
...
def geolocalize_from_web(ip):
    ...
    if ip.startswith('130.206'):  # local address, from CIPF :)
        return 39.634609, 2.647983, 'Palma de Mallorca', 'Spain', 'ES'  # coordinates of the UIB Palma de Mallorca
