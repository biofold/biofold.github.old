...
this.constraints = constraints;
}, "J.minimize.forcefield.ForceField,~A,~A,~A,~A,java.util.List");
...
}, "java.util.List,J.minimize.forcefield.Calculations.PairCalc,java.util.List,J.minimize.forcefield.Calculations.PairCalc");
...
}if (J.minimize.Util.isNearZero (c.rab, 1.0e-3)) c.rab = 1.0e-3;
