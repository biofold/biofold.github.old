...
Clazz.load (["J.minimize.forcefield.Calculation", "$.Calculations"], "J.minimize.forcefield.CalculationsUFF", ["java.util.ArrayList", "J.minimize.Util"], function () {
...
this.pairSearch (this.calculations[5] =  new java.util.ArrayList (), Clazz.innerTypeInstance (J.minimize.forcefield.CalculationsUFF.VDWCalc, this, null), null, null);
return true;
});
...
default:
return Clazz.superCall (this, J.minimize.forcefield.CalculationsUFF, "getDebugHeader", [iType]);
}
}, "~N");
