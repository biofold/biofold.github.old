...
Clazz.load (["J.minimize.forcefield.Calculation", "$.Calculations"], "J.minimize.forcefield.CalculationsMMFF", ["java.util.ArrayList", "J.minimize.MinAtom", "$.MinObject", "J.util.TextFormat"], function () {
...
}, "J.minimize.forcefield.ForceField,java.util.Map,~A,~A,~A,~A,java.util.List");
...
this.pairSearch (this.calculations[5] =  new java.util.ArrayList (), Clazz.innerTypeInstance (J.minimize.forcefield.CalculationsMMFF.VDWCalc, this, null), this.calculations[6] =  new java.util.ArrayList (), Clazz.innerTypeInstance (J.minimize.forcefield.CalculationsMMFF.ESCalc, this, null));
return true;
});
...
default:
return Clazz.superCall (this, J.minimize.forcefield.CalculationsMMFF, "getDebugHeader", [iType]);
}
}, "~N");
...
}, "java.util.List,J.minimize.MinBond");
Clazz.overrideMethod (c$, "compute", 
function (a) {
this.getPointers (a);
...
}, "java.util.List,J.minimize.MinAngle");
Clazz.overrideMethod (c$, "compute", 
function (a) {
this.key = a[2];
this.getPointers (a);
...
if (c == null) return;
a.add ([b.data, c, b.key]);
}, "java.util.List,J.minimize.MinTorsion");
Clazz.overrideMethod (c$, "compute", 
function (a) {
this.key = a[2];
this.getPointers (a);
...
a.add ([[b, c], [this.b$["J.minimize.forcefield.CalculationsMMFF"].minAtoms[b].partialCharge, this.b$["J.minimize.forcefield.CalculationsMMFF"].minAtoms[c].partialCharge, (this.b$["J.minimize.forcefield.CalculationsMMFF"].minAtoms[b].bs14.get (c) ? 249.0537 : 332.0716)]]);
}, "java.util.List,~N,~N");
Clazz.overrideMethod (c$, "compute", 
function (a) {
this.getPointers (a);
