...
}, "J.viewer.Viewer,J.modelset.ModelSet");
Clazz.makeConstructor (c$, 
function (viewer) {
this.viewer = viewer;
...
for (var i = 0; i < J.viewer.ShapeManager.clickableMax; i++) if ((shape = this.shapes[J.viewer.ShapeManager.hoverable[i]]) != null && (map = shape.checkObjectClicked (x, y, modifiers, bsVisible)) != null) return map;
...
if (this.shapes[23] != null) this.shapes[23].setProperty ("deleteVdw", null, bs);
...
function () {
if (this.shapes[23] == null) return;
this.setShapePropertyBs (23, "remapInherited", null, null);
});
