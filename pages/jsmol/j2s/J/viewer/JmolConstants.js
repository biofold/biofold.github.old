...
Clazz.load (["java.io.BufferedInputStream", "java.util.Properties", "J.util.Elements", "$.StringXBuilder", "$.Vector3f"], "J.viewer.JmolConstants", ["java.lang.NullPointerException", "java.util.Hashtable", "J.util.Logger", "$.Parser"], function () {
c$ = Clazz.declareType (J.viewer, "JmolConstants");
...
function (atomID) {
return J.viewer.JmolConstants.specialAtomNames[atomID];
}, "~N");
c$.getSpecialAtomNames = Clazz.defineMethod (c$, "getSpecialAtomNames", 
($fz = function () {
($t$ = J.viewer.JmolConstants.htSpecialAtoms =  new java.util.Hashtable (), J.viewer.JmolConstants.prototype.htSpecialAtoms = J.viewer.JmolConstants.htSpecialAtoms, $t$);
for (var i = J.viewer.JmolConstants.specialAtomNames.length; --i >= 0; ) {
var specialAtomName = J.viewer.JmolConstants.specialAtomNames[i];
if (specialAtomName != null) J.viewer.JmolConstants.htSpecialAtoms.put (specialAtomName, Integer.$valueOf (i));
}
}, $fz.isPrivate = true, $fz));
c$.lookupSpecialAtomID = Clazz.defineMethod (c$, "lookupSpecialAtomID", 
function (atomName) {
if (J.viewer.JmolConstants.htSpecialAtoms == null) J.viewer.JmolConstants.getSpecialAtomNames ();
var boxedAtomID = J.viewer.JmolConstants.htSpecialAtoms.get (atomName);
...
function (pt) {
return (pt < 0 || pt >= J.viewer.JmolConstants.pdbHydrogenCount.length ? -1 : J.viewer.JmolConstants.pdbHydrogenCount[pt]);
}, "~N");
c$.getPdbBondInfo = Clazz.defineMethod (c$, "getPdbBondInfo", 
function (pt) {
if (pt < 0 || pt > J.viewer.JmolConstants.pdbBondInfo.length) return null;
var s = J.viewer.JmolConstants.pdbBondInfo[pt];
...
function () {
if (J.viewer.JmolConstants.group3List != null) return J.viewer.JmolConstants.group3List;
var s =  new J.util.StringXBuilder ();
for (var i = 1; i < 42; i++) s.append (",[").append ((J.viewer.JmolConstants.predefinedGroup3Names[i] + "   ").substring (0, 3) + "]");
...
($t$ = J.viewer.JmolConstants.group3Count = Clazz.doubleToInt (s.length () / 6), J.viewer.JmolConstants.prototype.group3Count = J.viewer.JmolConstants.group3Count, $t$);
return ($t$ = J.viewer.JmolConstants.group3List = s.toString (), J.viewer.JmolConstants.prototype.group3List = J.viewer.JmolConstants.group3List, $t$);
});
c$.isHetero = Clazz.defineMethod (c$, "isHetero", 
function (group3) {
return J.viewer.JmolConstants.getGroup3Pt (group3) >= 42;
}, "~S");
c$.getGroup3Pt = Clazz.defineMethod (c$, "getGroup3Pt", 
($fz = function (group3) {
J.viewer.JmolConstants.getGroup3List ();
var sb =  new J.util.StringXBuilder ().append ("[");
sb.append (group3);
...
var pt = J.viewer.JmolConstants.group3List.indexOf (sb.toString ());
return (pt < 0 ? 2147483647 : Clazz.doubleToInt (pt / 6) + 1);
}, $fz.isPrivate = true, $fz), "~S");
c$.getGroup3Count = Clazz.defineMethod (c$, "getGroup3Count", 
function () {
if (J.viewer.JmolConstants.group3Count > 0) return J.viewer.JmolConstants.group3Count;
J.viewer.JmolConstants.getGroup3List ();
return ($t$ = J.viewer.JmolConstants.group3Count = Clazz.doubleToInt (J.viewer.JmolConstants.group3List.length / 6), J.viewer.JmolConstants.prototype.group3Count = J.viewer.JmolConstants.group3Count, $t$);
});
...
if (shapeID < 0) return J.viewer.JmolConstants.shapeClassBases[~shapeID];
return "J." + (isRenderer ? "render" : "shape") + (shapeID >= 9 && shapeID < 16 ? "bio." : shapeID >= 16 && shapeID < 23 ? "special." : shapeID >= 23 && shapeID < 29 ? "surface." : ".") + J.viewer.JmolConstants.shapeClassBases[shapeID];
}, "~N,~B");
...
($t$ = J.viewer.JmolConstants.version = (tmpVersion != null ? tmpVersion : "(Unknown version)"), J.viewer.JmolConstants.prototype.version = J.viewer.JmolConstants.version, $t$);
($t$ = J.viewer.JmolConstants.date = (tmpDate != null ? tmpDate : "(Unknown date)"), J.viewer.JmolConstants.prototype.date = J.viewer.JmolConstants.date, $t$);
}Clazz.defineStatics (c$,
...
c$.center = c$.prototype.center = J.util.Vector3f.new3 (0, 0, 0);
c$.axisX = c$.prototype.axisX = J.util.Vector3f.new3 (1, 0, 0);
c$.axisY = c$.prototype.axisY = J.util.Vector3f.new3 (0, 1, 0);
c$.axisZ = c$.prototype.axisZ = J.util.Vector3f.new3 (0, 0, 1);
c$.axisNX = c$.prototype.axisNX = J.util.Vector3f.new3 (-1, 0, 0);
c$.axisNY = c$.prototype.axisNY = J.util.Vector3f.new3 (0, -1, 0);
c$.axisNZ = c$.prototype.axisNZ = J.util.Vector3f.new3 (0, 0, -1);
c$.unitAxisVectors = c$.prototype.unitAxisVectors = [J.viewer.JmolConstants.axisX, J.viewer.JmolConstants.axisY, J.viewer.JmolConstants.axisZ, J.viewer.JmolConstants.axisNX, J.viewer.JmolConstants.axisNY, J.viewer.JmolConstants.axisNZ];
Clazz.defineStatics (c$,
"XY_ZTOP", 100,
...
c$.FORMAL_CHARGE_COLIX_WHITE = c$.prototype.FORMAL_CHARGE_COLIX_WHITE = (J.viewer.JmolConstants.FORMAL_CHARGE_COLIX_RED + 4);
c$.FORMAL_CHARGE_COLIX_BLUE = c$.prototype.FORMAL_CHARGE_COLIX_BLUE = (J.viewer.JmolConstants.FORMAL_CHARGE_COLIX_WHITE + 7);
Clazz.defineStatics (c$,
...
c$.FORMAL_CHARGE_INDEX_MAX = c$.prototype.FORMAL_CHARGE_INDEX_MAX = J.viewer.JmolConstants.argbsFormalCharge.length;
c$.PARTIAL_CHARGE_COLIX_RED = c$.prototype.PARTIAL_CHARGE_COLIX_RED = (J.viewer.JmolConstants.FORMAL_CHARGE_COLIX_BLUE + 1);
c$.PARTIAL_CHARGE_COLIX_WHITE = c$.prototype.PARTIAL_CHARGE_COLIX_WHITE = (J.viewer.JmolConstants.PARTIAL_CHARGE_COLIX_RED + 15);
c$.PARTIAL_CHARGE_COLIX_BLUE = c$.prototype.PARTIAL_CHARGE_COLIX_BLUE = (J.viewer.JmolConstants.PARTIAL_CHARGE_COLIX_WHITE + 15);
Clazz.defineStatics (c$,
...
c$.ATOMID_MAX = c$.prototype.ATOMID_MAX = J.viewer.JmolConstants.specialAtomNames.length;
Clazz.defineStatics (c$,
...
"CURSOR_ZOOM", 5);
{
if (J.viewer.JmolConstants.argbsFormalCharge.length != 12) {
J.util.Logger.error ("formal charge color table length");
throw  new NullPointerException ();
}if (J.viewer.JmolConstants.shapeClassBases.length != 35) {
J.util.Logger.error ("shapeClassBases wrong length");
throw  new NullPointerException ();
}if (J.viewer.JmolConstants.argbsAmino.length != 24) {
J.util.Logger.error ("argbsAmino wrong length");
throw  new NullPointerException ();
}if (J.viewer.JmolConstants.argbsShapely.length != 42) {
J.util.Logger.error ("argbsShapely wrong length");
throw  new NullPointerException ();
}if (J.viewer.JmolConstants.argbsChainHetero.length != J.viewer.JmolConstants.argbsChainAtom.length) {
