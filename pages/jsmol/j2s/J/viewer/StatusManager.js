...
Clazz.load (["java.util.Hashtable"], "J.viewer.StatusManager", ["java.lang.Boolean", "$.Float", "java.util.ArrayList", "$.Collections", "J.api.Interface", "J.constant.EnumCallback", "J.util.Logger", "$.TextFormat"], function () {
...
function (width, height) {
if (this.jmolStatusListener != null) this.jmolStatusListener.resizeInnerPanel ("preferredWidthHeight " + width + " " + height + ";");
}, "~N,~N");
