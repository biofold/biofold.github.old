...
Clazz.load (["java.util.Hashtable"], "J.viewer.binding.Binding", ["java.lang.Boolean", "java.util.ArrayList", "$.Arrays", "J.api.Interface", "J.util.Escape", "$.Logger", "$.SB"], function () {
...
names[i].add (J.viewer.binding.Binding.getMouseActionName (info[0], true));
}
