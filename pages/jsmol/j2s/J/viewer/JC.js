...
return "J." + (isRenderer ? "render" : "shape") + (shapeID >= 9 && shapeID < 16 ? "bio." : shapeID >= 16 && shapeID < 23 ? "special." : shapeID >= 23 && shapeID < 29 ? "surface." : ".") + J.viewer.JC.shapeClassBases[shapeID];
}, "~N,~B");
...
}if (J.viewer.JC.shapeClassBases.length != 35) {
