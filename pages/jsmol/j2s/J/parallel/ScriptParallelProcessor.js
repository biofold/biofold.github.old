...
Clazz.load (["J.api.JmolParallelProcessor", "J.script.ScriptFunction", "java.util.ArrayList"], "J.parallel.ScriptParallelProcessor", ["java.util.concurrent.Executors", "J.parallel.ScriptProcess", "$.ScriptProcessRunnable", "J.util.Logger", "J.viewer.ShapeManager", "$.Viewer"], function () {
...
this.processes.add ( new J.parallel.ScriptProcess (name, context));
