...
return;
}Clazz.superCall (this, J.shape.Sticks, "setProperty", [propertyName, value, bs]);
}, "~S,~O,J.util.BS");
Clazz.overrideMethod (c$, "getProperty", 
function (property, index) {
if (property.equals ("selectionState")) return (this.selectedBonds != null ? "select BONDS " + J.util.Escape.e (this.selectedBonds) + "\n" : "");
