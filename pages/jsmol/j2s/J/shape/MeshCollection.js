...
this.currentMesh = this.meshes[index] = (m == null ?  new J.shape.Mesh (thisID, this.colix, index) : m);
...
return;
}Clazz.superCall (this, J.shape.MeshCollection, "setProperty", [propertyName, value, bs]);
}, "~S,~O,J.util.BS");
...
if (range != null) sb.append ("; dataRange:").append (J.util.Escape.e (range));
if (m.title != null) {
var s = "";
