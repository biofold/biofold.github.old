...
Clazz.load (["J.api.JmolMeasurementClient", "J.shape.AtomShape", "java.util.ArrayList"], "J.shape.Measures", ["java.lang.Float", "java.util.Hashtable", "J.modelset.Measurement", "$.MeasurementData", "J.util.BS", "$.BSUtil", "$.C", "$.Escape"], function () {
...
this.showHideM ( new J.modelset.Measurement (this.modelSet, value, null, null), true);
return;
}if ("reformatDistances" === propertyName) {
this.reformatDistances ();
return;
}if ("show" === propertyName) {
this.showHideM ( new J.modelset.Measurement (this.modelSet, value, null, null), false);
return;
}if ("toggle" === propertyName) {
this.toggle ( new J.modelset.Measurement (this.modelSet, value, null, null));
return;
...
return  new J.modelset.Measurement (this.modelSet, indices, points, this.tickInfo == null ? this.defaultTickInfo : this.tickInfo);
...
this.radiusData = null;
this.bsSelected =  new J.util.BS ();
this.defineAll (-2147483648,  new J.modelset.Measurement (this.modelSet, indices, null, this.defaultTickInfo), false, true, true);
this.setIndices ();
this.reformatDistances ();
...
this.defineAll (-2147483648,  new J.modelset.Measurement (this.modelSet, value, null, null), true, false, false);
...
return;
}var measureNew =  new J.modelset.Measurement (this.modelSet, m, value, (m.colix == 0 ? this.colix : m.colix), this.strFormat, this.measurementCount);
