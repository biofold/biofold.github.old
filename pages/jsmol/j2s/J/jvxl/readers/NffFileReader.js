...
Clazz.load (["J.jvxl.readers.PolygonFileReader", "java.util.Hashtable", "J.util.Point3f"], "J.jvxl.readers.NffFileReader", ["java.lang.Float", "J.jvxl.data.JvxlCoder", "J.util.ColorUtil", "$.Logger"], function () {
c$ = Clazz.decorateAsClass (function () {
this.nPolygons = 0;
this.vertexMap = null;
this.pt = null;
Clazz.instantialize (this, arguments);
}, J.jvxl.readers, "NffFileReader", J.jvxl.readers.PolygonFileReader);
Clazz.prepareFields (c$, function () {
this.vertexMap =  new java.util.Hashtable ();
this.pt =  new J.util.Point3f ();
});
Clazz.makeConstructor (c$, 
function () {
Clazz.superConstructor (this, J.jvxl.readers.NffFileReader, []);
});
