...
if (J.util.Logger.debugging) J.util.Logger.debug ("tri: " + iA + " " + iB + " " + iC);
return Clazz.superCall (this, J.jvxl.readers.PmeshReader, "addTriangleCheck", [iA, iB, iC, check, check2, isAbsolute, color]);
}, "~N,~N,~N,~N,~N,~B,~N");
