...
function (sg, br) {
Clazz.superCall (this, J.jvxl.readers.KinemageReader, "init2", [sg, br]);
this.type = "kinemage";
this.setHeader ();
...
return Clazz.superCall (this, J.jvxl.readers.KinemageReader, "readVolumeParameters", [isMapData]);
}, "~B");
