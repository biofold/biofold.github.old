...
Clazz.load (["J.jvxl.readers.JvxlXmlReader"], "J.jvxl.readers.JvxlReader", ["java.lang.NullPointerException", "J.jvxl.data.JvxlCoder", "J.jvxl.readers.VolumeFileReader", "J.util.C", "$.Escape", "$.Logger", "$.Parser", "$.Point4f", "$.SB"], function () {
...
this.readLine ();
str += J.jvxl.data.JvxlCoder.jvxlUncompressString (this.line);
}
} catch (e) {
...
if (param1 == -1) {
try {
this.params.thePlane = J.util.Point4f.new4 (this.parseFloat (), this.parseFloat (), this.parseFloat (), this.parseFloat ());
} catch (e) {
if (Clazz.exceptionOf (e, Exception)) {
...
while (n < nPoints) {
this.readLine ();
n += (isInt ? this.countData (this.line) : J.jvxl.data.JvxlCoder.jvxlUncompressString (this.line).length);
}
