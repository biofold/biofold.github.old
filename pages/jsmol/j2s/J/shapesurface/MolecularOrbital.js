...
Clazz.load (["J.shapesurface.Isosurface"], "J.shapesurface.MolecularOrbital", ["java.lang.Boolean", "$.Float", "java.util.ArrayList", "$.Hashtable", "J.constant.EnumQuantumShell", "J.jvxl.data.JvxlCoder", "J.util.ArrayUtil", "$.Escape", "$.SB"], function () {
...
this.myType = "mo";
Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["thisID", "mo", null]);
});
...
Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["init", null, null]);
Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["modelIndex", Integer.$valueOf (modelIndex), null]);
...
Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["color", value, bs]);
...
return;
}Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", [propertyName, value, bs]);
}, "~S,~O,J.util.BS");
...
var s = Clazz.superCall (this, J.shapesurface.MolecularOrbital, "getProperty", ["list", param]);
if (s.length > 1) s += "cutoff = " + Clazz.superCall (this, J.shapesurface.MolecularOrbital, "getProperty", ["cutoff", 0]) + "\n";
...
Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["init", params, null]);
...
if (!doOneMo) Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["delete", "mo_show", null]);
if (nTotal == 1) break;
}
str.append (J.jvxl.data.JvxlCoder.jvxlGetFile (this.jvxlData, null, null, "TRAILERONLY", true, 0, null, null));
return str.toString ();
}return Clazz.superCall (this, J.shapesurface.MolecularOrbital, "getProperty", [propertyName, param]);
}, "~S,~N");
...
Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["reset", this.strID, null]);
if (this.moDebug) Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["debug", Boolean.TRUE, null]);
this.getSettings (this.strID);
if (this.moScale != null) Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["scale", this.moScale, null]);
if (this.moResolution != null) Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["resolution", this.moResolution, null]);
if (this.moPlane != null) {
Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["plane", this.moPlane, null]);
if (this.moCutoff != null) {
Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["red",  new Float (-this.moCutoff.floatValue ()), null]);
Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["blue", this.moCutoff, null]);
}} else {
if (this.moCutoff != null) Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", [(this.moIsPositiveOnly ? "cutoffPositive" : "cutoff"), this.moCutoff, null]);
if (this.moColorNeg != null) Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["colorRGB", this.moColorNeg, null]);
if (this.moColorPos != null) Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["colorRGB", this.moColorPos, null]);
if (this.moMonteCarloCount != null) {
Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["randomSeed", this.moRandomSeed, null]);
Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["monteCarloCount", this.moMonteCarloCount, null]);
}}Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["squareData", this.moSquareData, null]);
Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["squareLinear", this.moSquareLinear, null]);
Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["title", this.moTitleFormat, null]);
Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["fileName", this.viewer.getFileName (), null]);
Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["molecularOrbital", linearCombination == null ? Integer.$valueOf (moNumber) : linearCombination, null]);
if (this.moPlane != null && this.moColorNeg != null) Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["colorRGB", this.moColorNeg, null]);
if (this.moPlane != null && this.moColorPos != null) Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["colorRGB", this.moColorPos, null]);
this.currentMesh.isColorSolid = false;
if (this.moSlabValue != null) Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["slab", this.moSlabValue, null]);
if (this.moSlab != null) for (var i = 0; i < this.moSlab.size (); i++) Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["slab", this.moSlab.get (i), null]);

if (this.moTranslucentLevel != null) Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["translucenctLevel", this.moTranslucentLevel, null]);
if (this.moTranslucency != null) Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["translucency", this.moTranslucency, null]);
Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["token", Integer.$valueOf (this.moFill), null]);
Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["token", Integer.$valueOf (this.moMesh), null]);
Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["token", Integer.$valueOf (this.moDots), null]);
Clazz.superCall (this, J.shapesurface.MolecularOrbital, "setProperty", ["token", Integer.$valueOf (this.moFrontOnly), null]);
