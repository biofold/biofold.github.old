...
if (J.modelset.Bond.isHydrogen (order) || (order & 256) != 0) return J.util.JmolEdge.EnumBondOrder.SINGLE.number;
...
if (J.modelset.Bond.isHydrogen (order)) return J.util.JmolEdge.EnumBondOrder.H_REGULAR.$$name;
