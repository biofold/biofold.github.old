...
Clazz.load (["J.util.P3", "$.P3i", "$.V3"], "J.util.BoxInfo", ["java.util.ArrayList", "$.Hashtable", "J.util.Measure", "$.Point3fi", "$.Point4f", "$.TriangleData"], function () {
...
J.util.Measure.getPlaneThroughPoints (va, vb, vc, vNorm, vAB, vAC, faces[i] =  new J.util.Point4f ());
}
return faces;
}, "~A");
