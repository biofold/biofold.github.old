...
Clazz.load (null, "J.util.ColorEncoder", ["java.lang.Boolean", "$.Float", "java.util.ArrayList", "$.Hashtable", "J.constant.EnumPalette", "J.util.ArrayUtil", "$.C", "$.ColorUtil", "$.Escape", "$.Logger", "$.TextFormat", "J.viewer.JC"], function () {
...
colors.add (J.util.ColorUtil.colorPointFromInt2 (this.getArgb (values[i] + f)));
}
