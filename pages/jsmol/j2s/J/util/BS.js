...
Clazz.load (null, "J.util.BS", ["java.lang.IndexOutOfBoundsException", "$.InternalError", "$.NegativeArraySizeException", "J.util.SB"], function () {
...
if (wordCount == 0) bs.words = J.util.BS.emptyBitmap;
 else {
...
($fz = function () {
return Clazz.superCall (this, J.util.BS, "clone", []);
}, $fz.isPrivate = true, $fz));
