...
Clazz.load (null, "J.util.BitSet", ["java.lang.IndexOutOfBoundsException", "$.InternalError", "$.NegativeArraySizeException", "J.util.StringXBuilder"], function () {
c$ = Clazz.decorateAsClass (function () {
this.words = null;
this.wordsInUse = 0;
this.sizeIsSticky = false;
Clazz.instantialize (this, arguments);
}, J.util, "BitSet", null, Cloneable);
...
($fz = function (nbits) {
this.words =  Clazz.newIntArray (J.util.BitSet.wordIndex (nbits - 1) + 1, 0);
}, $fz.isPrivate = true, $fz), "~N");
...
var wordIndex = J.util.BitSet.wordIndex (bitIndex);
...
var startWordIndex = J.util.BitSet.wordIndex (fromIndex);
var endWordIndex = J.util.BitSet.wordIndex (toIndex - 1);
...
var u = J.util.BitSet.wordIndex (fromIndex);
...
function (obj) {
if (!(Clazz.instanceOf (obj, J.util.BitSet))) return false;
...
return J.util.BitSet.copy (this);
});
...
var b = J.util.StringXBuilder.newN (6 * numBits + 2);
b.appendC ('{');
...
if (wordCount == 0) bs.words = J.util.BitSet.emptyBitmap;
 else {
...
($fz = function () {
return Clazz.superCall (this, J.util.BitSet, "clone", []);
}, $fz.isPrivate = true, $fz));
