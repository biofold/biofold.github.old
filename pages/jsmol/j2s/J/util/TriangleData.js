...
Clazz.load (["J.util.P3i"], "J.util.TriangleData", ["J.util.ArrayUtil", "$.BS", "$.BSUtil", "$.P3"], function () {
c$ = Clazz.declareType (J.util, "TriangleData");
c$.intersectPlane = Clazz.defineMethod (c$, "intersectPlane", 
function (plane, v, flags) {
if (plane == null) {
v.add (J.util.TriangleData.fullCubePolygon);
return v;
...
return v;
}, "J.util.Point4f,java.util.List,~N");
