...
Clazz.load (null, "J.util.MeshSurface", ["java.lang.Boolean", "$.Float", "java.util.ArrayList", "$.Hashtable", "J.util.ArrayUtil", "$.BS", "$.BSUtil", "$.BoxInfo", "$.C", "$.Escape", "$.Geodesic", "$.Measure", "$.P3", "$.SB", "$.TextFormat"], function () {
...
if (Clazz.instanceOf (plane, J.util.Point4f)) return J.util.MeshSurface.getSlabObject (135266319, plane, isCap, null);
} catch (e) {
...
if (isGhost) sb.append ("translucent ").appendF (J.util.C.getColixTranslucencyFractional (this.slabColix)).append (" ").append (J.util.C.getHexCode (this.slabColix)).append (" ");
switch (slabType) {
case 1073741872:
sb.append ("brillouin");
...
}}, "~N,J.util.Point4f,~A,java.util.List,~A,J.util.BS,J.util.MeshSurface,~B,~B,~N,~B");
...
}, $fz.isPrivate = true, $fz), "~N,J.util.P3,~N,~N,J.util.Point4f,~A,J.util.BS");
