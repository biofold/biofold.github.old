...
red = J.util.Parser.parseFloatStr (tokens[0]);
grn = J.util.Parser.parseFloatStr (tokens[1]);
blu = J.util.Parser.parseFloatStr (tokens[2]);
...
try {
red = J.util.Parser.parseIntRadix (strColor.substring (1, 3), 16);
grn = J.util.Parser.parseIntRadix (strColor.substring (3, 5), 16);
blu = J.util.Parser.parseIntRadix (strColor.substring (5, 7), 16);
return J.util.ColorUtil.colorTriadToInt (red, grn, blu);
} catch (e) {
