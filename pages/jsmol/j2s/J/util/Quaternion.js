...
Clazz.load (["J.util.Point4f"], "J.util.Quaternion", ["java.lang.Float", "J.util.AxisAngle4f", "$.Escape", "$.Logger", "$.Matrix3f", "$.P3", "$.TextFormat", "$.V3"], function () {
...
this.q2 = pt.y / factor;
this.q3 = pt.z / factor;
}, $fz.isPrivate = true, $fz), "J.util.Point4f");
...
function () {
return J.util.Point4f.new4 (this.q1, this.q2, this.q3, this.q0);
});
...
return J.util.Quaternion.newP4 (J.util.Point4f.new4 (mean.x, mean.y, mean.z, f));
...
c$.qZero = c$.prototype.qZero =  new J.util.Point4f ();
});
