...
Clazz.load (["J.util.Tuple3f"], "J.util.Vector3f", null, function () {
c$ = Clazz.declareType (J.util, "Vector3f", J.util.Tuple3f);
c$.newV = Clazz.defineMethod (c$, "newV", 
function (t) {
var v =  new J.util.Vector3f ();
v.x = t.x;
v.y = t.y;
v.z = t.z;
return v;
...
}, "J.util.Vector3f,J.util.Vector3f");
