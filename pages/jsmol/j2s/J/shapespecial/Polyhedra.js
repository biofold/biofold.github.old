...
}Clazz.superCall (this, J.shapespecial.Polyhedra, "setProperty", [propertyName, value, bs]);
}, "~S,~O,J.util.BS");
...
var d = J.util.Measure.distanceToPlane (norm, w, ptX);
...
return "  polyhedra ({" + this.centralAtom.getIndex () + "}) " + (this.myDistanceFactor == 1.85 ? "" : " distanceFactor " + this.myDistanceFactor) + (this.myFaceCenterOffset == 0.25 ? "" : " faceCenterOffset " + this.myFaceCenterOffset) + " to " + J.util.Escape.e (a) + (this.collapsed ? " collapsed" : "") + (this.isFullyLit ? " fullyLit" : "") + ";" + (this.visible ? "" : "polyhedra off;") + "\n";
});
c$ = Clazz.p0p ();
};
