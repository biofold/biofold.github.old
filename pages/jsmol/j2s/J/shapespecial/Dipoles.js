...
Clazz.load (["J.shape.Shape", "J.util.P3"], "J.shapespecial.Dipoles", ["java.lang.Float", "java.util.ArrayList", "$.Hashtable", "J.script.T", "J.shapespecial.Dipole", "J.util.ArrayUtil", "$.BSUtil", "$.C", "$.Logger", "$.SB", "$.TextFormat", "$.V3"], function () {
