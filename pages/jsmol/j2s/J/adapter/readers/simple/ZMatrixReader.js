...
Clazz.load (["J.adapter.smarter.AtomSetCollectionReader", "java.util.ArrayList", "$.Hashtable", "J.util.P3", "$.Point4f", "$.V3"], "J.adapter.readers.simple.ZMatrixReader", ["java.lang.Character", "$.Exception", "$.Float", "J.adapter.smarter.Atom", "$.Bond", "J.api.JmolAdapter", "J.util.Logger", "$.Measure", "$.Quaternion"], function () {
...
this.plane1 =  new J.util.Point4f ();
this.plane2 =  new J.util.Point4f ();
});
