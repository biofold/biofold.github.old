...
Clazz.load (["J.adapter.readers.quantum.BasisFunctionReader", "java.util.ArrayList"], "J.adapter.readers.quantum.SlaterReader", ["java.util.Arrays", "J.quantum.SlaterData", "J.util.Logger"], function () {
...
this.slaters.add ( new J.quantum.SlaterData (iAtom, a, b, c, d, zeta, coef));
}, "~N,~N,~N,~N,~N,~N,~N");
Clazz.defineMethod (c$, "addSlater", 
function (sd, n) {
sd.index = n;
