...
Clazz.load (["J.adapter.readers.quantum.MOReader"], "J.adapter.readers.quantum.GenNBOReader", ["java.io.BufferedReader", "$.StringReader", "java.lang.Boolean", "$.Character", "$.Exception", "$.Float", "java.util.ArrayList", "$.Hashtable", "J.api.JmolAdapter", "J.util.ArrayUtil", "$.Logger", "$.SB"], function () {
