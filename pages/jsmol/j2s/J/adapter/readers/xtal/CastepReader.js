...
Clazz.load (["J.adapter.smarter.AtomSetCollectionReader"], "J.adapter.readers.xtal.CastepReader", ["java.lang.Float", "java.util.ArrayList", "J.adapter.smarter.Atom", "J.util.Eigen", "$.Escape", "$.Logger", "$.P3", "$.TextFormat", "$.V3"], function () {
...
J.util.Logger.info ("tensor " + atom.atomName + "\t" + J.util.Escape.e (data));
