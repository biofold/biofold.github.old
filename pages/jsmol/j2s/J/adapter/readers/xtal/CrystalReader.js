...
Clazz.load (["J.adapter.smarter.AtomSetCollectionReader", "J.util.P3"], "J.adapter.readers.xtal.CrystalReader", ["java.lang.Character", "$.Double", "$.Float", "java.util.ArrayList", "$.Arrays", "J.util.BS", "$.Eigen", "$.Escape", "$.Logger", "$.Matrix3f", "$.Quaternion", "$.SB", "$.TextFormat", "$.V3"], function () {
