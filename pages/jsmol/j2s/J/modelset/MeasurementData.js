...
Clazz.load (["J.api.JmolMeasurementClient"], "J.modelset.MeasurementData", ["java.util.ArrayList", "J.modelset.Measurement", "J.util.BSUtil"], function () {
...
this.viewer = viewer;
this.points = points;
}, "J.viewer.Viewer,java.util.List");
...
var m =  new J.modelset.Measurement (modelSet, indices, pts, null);
m.setCount (nPoints);
var ptLastAtom = -1;
