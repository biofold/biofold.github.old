...
this.groupID = J.modelset.Group.getGroupID (group3);
...
function () {
return J.modelset.Group.getSeqcodeString (this.seqcode);
});
c$.getSeqcode = Clazz.defineMethod (c$, "getSeqcode", 
function (sequenceNumber, insertionCode) {
return J.modelset.Group.getSeqcode2 (sequenceNumber, insertionCode);
}, "~N,~S");
...
if (insertionCode != ' ' && insertionCode != '\0') J.util.Logger.warn ("unrecognized insertionCode:" + insertionCode);
insertionCode = '\0';
