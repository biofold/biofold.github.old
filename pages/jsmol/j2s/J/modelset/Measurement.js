...
Clazz.load (null, "J.modelset.Measurement", ["java.lang.Float", "java.util.ArrayList", "J.atomdata.RadiusData", "J.constant.EnumVdw", "J.modelset.LabelToken", "J.util.AxisAngle4f", "$.Escape", "$.Measure", "$.P3", "$.SB", "$.V3"], function () {
...
return -1;
}, "java.util.List,J.modelset.Measurement");
