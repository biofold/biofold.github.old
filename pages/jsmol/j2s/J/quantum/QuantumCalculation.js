...
J.util.Logger.info ("QuantumCalculation:\n origin = " + J.util.Escape.e (originXYZ) + "\n steps = " + J.util.Escape.e (stepsXYZ) + "\n origin(Bohr)= " + J.util.Escape.e (this.originBohr) + "\n steps(Bohr)= " + J.util.Escape.e (this.stepBohr) + "\n counts= " + this.nX + " " + this.nY + " " + this.nZ);
...
for (var i = i0, j = 0; i >= 0; i = (isAll ? i - 1 : bsSelected.nextSetBit (i + 1))) this.qmAtoms[renumber ? j++ : i] =  new J.quantum.QMAtom (i, atomCoordAngstroms[i], this.X, this.Y, this.Z, this.X2, this.Y2, this.Z2, (this.bsExcluded != null && this.bsExcluded.get (i)), this.unitFactor);
