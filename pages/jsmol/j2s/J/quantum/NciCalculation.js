...
if (parameters != null) J.util.Logger.info ("NCI calculation parameters = " + J.util.Escape.e (parameters));
...
this.nMolecules++;
J.util.Logger.info ("Molecule " + (this.nMolecules) + " (" + bs.cardinality () + " atoms): " + J.util.Escape.e (bs));
}
