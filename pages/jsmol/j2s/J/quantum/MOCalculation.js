...
Clazz.load (["J.api.QuantumCalculationInterface", "J.quantum.QuantumCalculation"], "J.quantum.MOCalculation", ["J.constant.EnumQuantumShell", "J.util.Logger"], function () {
...
}, J.quantum, "MOCalculation", J.quantum.QuantumCalculation, J.api.QuantumCalculationInterface);
...
}, "J.api.VolumeDataInterface,J.util.BS,J.util.BS,~A,~S,~A,~N,java.util.List,~A,~A,~O,~A,~A,~B,~A,~A,~B,~A,~A,~N");
Clazz.defineMethod (c$, "initialize", 
function (nX, nY, nZ, points) {
Clazz.superCall (this, J.quantum.MOCalculation, "initialize", [nX, nY, nZ, points]);
