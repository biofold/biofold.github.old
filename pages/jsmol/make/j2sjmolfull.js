...
dobhtest = function(fxName, objThis, clazzFun, params,
					funParams/*, isSuper, clazzThis*/, fx) {

          //dobhtest() used to allow developer-mode checking in Firefox
          
          // called from Clazz.searchAndExecuteMethod 
...
dobhtest(fxName, objThis, clazzFun, params,
					funParams/*, isSuper, clazzThis*/, fx)
...
Clazz.defineMethod = function (clazzThis, funName, funBody, funParams) {
	...
	if (f$ == null || (f$.claxxOwner === clazzThis
		...
		funBody.claxxOwner = clazzThis;
		clazzThis.prototype[funName] = funBody;
		funBody.exClazz = clazzThis; // make it traceabl
  delete $fz;
		return funBody;
	}
	var oldFun = null;
