...
if (this.spaceGroup == null) this.spaceGroup =  new J.symmetry.SpaceGroup (doNormalize);
}, "~B");
...
// 
Clazz.declarePackage ("J.symmetry");
Clazz.load (["J.util.P3", "$.V3"], "J.symmetry.PointGroup", ["java.lang.Float", "java.util.ArrayList", "$.Hashtable", "J.util.BSUtil", "$.Escape", "$.Logger", "$.Quaternion", "$.SB", "$.TextFormat"], function () {
c$ = Clazz.decorateAsClass (function () {
this.drawInfo = null;
this.info = null;
this.textInfo = null;
...
var symmetryOperation =  new J.symmetry.SymmetryOperation (this.doNormalize, opId);
...
Clazz.defineMethod (c$, "getLatticeDesignation", 
($fz = function () {
return J.symmetry.HallTranslation.getLatticeDesignation (this.latticeCode, this.isCentrosymmetric);
}, $fz.isPrivate = true, $fz));
...
return;
}this.translation =  new J.symmetry.HallTranslation ();
this.translationString = "";
var f = a.length;
for (var g = d; g < f; g++) {
var h = a.charAt (g);
var i =  new J.symmetry.HallTranslation (h, this.order);
...
case 3:
pt.z = J.symmetry.UnitCell.toFractional (pt.z);
case 2:
pt.y = J.symmetry.UnitCell.toFractional (pt.y);
case 1:
pt.x = J.symmetry.UnitCell.toFractional (pt.x);
}
...
return  new J.util.Quadric (null, lengths, true);
...
}return  new J.util.Quadric (Bcart);
}, "~A");
