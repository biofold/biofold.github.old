...
}, "~A,~A,~N,~N,J.util.BS,java.util.List,~A");
...
// 
Clazz.declarePackage ("J.smiles");
Clazz.load (["J.util.JmolMolecule", "java.util.ArrayList", "J.util.BS", "$.V3"], "J.smiles.SmilesSearch", ["java.util.Arrays", "$.Hashtable", "J.smiles.SmilesAromatic", "$.SmilesAtom", "$.SmilesBond", "$.SmilesMeasure", "$.SmilesParser", "J.util.ArrayUtil", "$.BSUtil", "$.Logger", "$.SB"], function () {
...
var sAtom =  new J.smiles.SmilesAtom (this.atomCount);
...
}, $fz.isPrivate = true, $fz), "java.util.List,J.util.BS,~N,java.util.List");
...
jn[4] =  new J.smiles.SmilesAtom (604);
...
if (!J.smiles.SmilesSearch.checkStereochemistry (sAtom.not, atom0, chiralClass, order, jn[0], jn[1], jn[2], jn[3], null, null, this.v)) return false;
continue;
case 4:
case 8:
case 5:
...
if (!J.smiles.SmilesSearch.checkStereochemistry (sAtom.not, atom0, chiralClass, order, atom1, atom2, atom3, atom4, atom5, atom6, this.v)) return false;
continue;
}
}
...
}jn[pt] =  new J.smiles.SmilesAtom (-1);
(jn[pt]).setT (v);
}}if (jn[pt] == null) {
...
if (n < 0) n = 0;
var atom = atoms[ptAtom] =  new J.smiles.SmilesAtom (0, ptAtom, cclass == -2147483648 ? cclass : (cclass << 8) + sAtom.getChiralOrder (), sAtom.elementNumber, sAtom.getCharge ());
...
atom.setBonds (bonds);
while (--n >= 0) {
var atomH = atoms[ptAtom] =  new J.smiles.SmilesAtom (0, ptAtom, 0, 1, 0);
ptAtom++;
...
// 
Clazz.declarePackage ("J.smiles");
Clazz.load (["java.util.Hashtable", "J.smiles.SmilesSearch", "J.util.BS"], "J.smiles.SmilesGenerator", ["java.util.ArrayList", "J.smiles.InvalidSmilesException", "$.SmilesAromatic", "$.SmilesAtom", "$.SmilesBond", "$.SmilesParser", "J.util.BSUtil", "$.Elements", "$.JmolMolecule", "$.Logger", "$.SB"], function () {
c$ = Clazz.decorateAsClass (function () {
this.atoms = null;
this.atomCount = 0;
this.bsSelected = null;
...
}, $fz.isPrivate = true, $fz), "J.util.JmolNode,java.util.List");
...
case 5:
case 6:
return (J.smiles.SmilesSearch.checkStereochemistry (false, atom0, chiralClass, 1, atom1, atom2, atom3, atom4, atom5, atom6, v) ? "@" : "@@");
case 2:
case 4:
...
chiralClass = 8;
if (J.smiles.SmilesSearch.checkStereochemistry (false, atom0, chiralClass, 1, atom1, atom2, atom3, atom4, atom5, atom6, v)) return "@SP1";
if (J.smiles.SmilesSearch.checkStereochemistry (false, atom0, chiralClass, 2, atom1, atom2, atom3, atom4, atom5, atom6, v)) return "@SP2";
if (J.smiles.SmilesSearch.checkStereochemistry (false, atom0, chiralClass, 3, atom1, atom2, atom3, atom4, atom5, atom6, v)) return "@SP3";
} else {
return (J.smiles.SmilesSearch.checkStereochemistry (false, atom0, chiralClass, 1, atom1, atom2, atom3, atom4, atom5, atom6, v) ? "@" : "@@");
}}
return "";
...
var bs = v5.get (i);
if (J.smiles.SmilesAromatic.isAromaticRing (bsAromatic, bsTest, bs, 5)) J.smiles.SmilesAromatic.checkAromaticStrict (jmolAtoms, bsStrict, v5, v6, bs, true);
}
for (var i = v6.size (); --i >= 0; ) {
var bs = v6.get (i);
if (J.smiles.SmilesAromatic.isAromaticRing (bsAromatic, bsTest, bs, 6)) J.smiles.SmilesAromatic.checkAromaticStrict (jmolAtoms, bsStrict, v5, v6, bs, false);
}
bsAromatic.clearAll ();
bsAromatic.or (bsStrict);
}, "~A,J.util.BS,java.util.List,java.util.List");
...
}, $fz.isPrivate = true, $fz), "~A,J.util.BS,java.util.List,java.util.List,J.util.BS,~B");
...
var sAtom =  new J.smiles.SmilesAtom (this.index);
sAtom.parent = this;
...
Clazz.makeConstructor (c$, 
function (index) {
Clazz.superConstructor (this, J.smiles.SmilesAtom, []);
this.index = index;
}, "~N");
Clazz.makeConstructor (c$, 
...
this.bondsOr = tmp;
}var sBond =  new J.smiles.SmilesBond (-1, false);
...
// 
Clazz.declarePackage ("J.smiles");
Clazz.load (["java.util.Hashtable"], "J.smiles.SmilesParser", ["java.lang.Character", "$.Float", "java.util.ArrayList", "J.smiles.InvalidSmilesException", "$.SmilesAtom", "$.SmilesBond", "$.SmilesMeasure", "$.SmilesSearch", "J.util.Elements", "$.Logger", "$.Parser", "$.SB", "$.TextFormat"], function () {
c$ = Clazz.decorateAsClass (function () {
this.isSmarts = false;
...
return  new J.smiles.SmilesBond (0, false);
