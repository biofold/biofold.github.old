...
Clazz.load (["J.adapter.smarter.AtomSetCollectionReader", "java.util.Hashtable"], "J.adapter.readers.cifpdb.PdbReader", ["java.lang.Boolean", "$.Character", "$.Float", "java.util.ArrayList", "J.adapter.smarter.Atom", "$.Structure", "J.api.Interface", "$.JmolAdapter", "J.constant.EnumStructure", "J.util.Escape", "$.Logger", "$.Matrix4f", "$.P3", "$.Parser", "$.SB", "$.TextFormat"], function () {
...
System.out.println ("TLS-U:  " + J.util.Escape.e (anisou));
anisou = (entry.getKey ().anisoBorU);
if (anisou != null) System.out.println ("ANISOU: " + J.util.Escape.e (anisou));
}
this.tlsU = null;
...
function (name, altID, group3, chain, seqNo, insCode, isHetero, sym) {
...
var atom = this.processAtom (this.line.substring (12, 16).trim (), this.line.charAt (16), this.parseTokenRange (this.line, 17, 20), this.line.charAt (21), this.getSeqNo (22, 26), this.line.charAt (26), isHetero, this.deduceElementSymbol (isHetero));
...
Clazz.superConstructor (this, J.modelsetbio.Monomer, [chain, group3, seqcode, firstAtomIndex, lastAtomIndex]);
...
function () {
var info = Clazz.superCall (this, J.modelsetbio.Monomer, "getGroupInfo", [this.groupIndex]);
...
Clazz.superCall (this, J.modelsetbio.Monomer, "selectAtoms", [bsResult]);
...
if (q1 == null || q2 == null) return Clazz.superCall (this, J.modelsetbio.Monomer, "getHelixData", [tokType, qType, mStep]);
var a = (mStep < 1 ? J.util.P3.new3 (0, 0, 0) : prev.getQuaternionFrameCenter (qType));
var b = this.getQuaternionFrameCenter (qType);
if (a == null || b == null) return Clazz.superCall (this, J.modelsetbio.Monomer, "getHelixData", [tokType, qType, mStep]);
...
}, $fz.isPrivate = true, $fz), "~N,java.util.List,J.modelset.Group");
...
return  new J.modelsetbio.AlphaMonomer (chain, group3, seqcode, firstIndex, lastIndex, J.modelsetbio.AlphaMonomer.alphaOffsets);
}, "J.modelset.Chain,~S,~N,~N,~N,~A");
...
Clazz.superConstructor (this, J.modelsetbio.Helix, [apolymer, J.constant.EnumStructure.HELIX, monomerIndex, monomerCount]);
...
Clazz.superConstructor (this, J.modelsetbio.Sheet, [alphaPolymer, J.constant.EnumStructure.SHEET, monomerIndex, monomerCount]);
...
Clazz.superConstructor (this, J.modelsetbio.Turn, [apolymer, J.constant.EnumStructure.TURN, monomerIndex, monomerCount]);
...
// 
Clazz.declarePackage ("J.modelsetbio");
Clazz.load (["J.util.V3"], "J.modelsetbio.BioPolymer", ["java.lang.Float", "java.util.ArrayList", "$.Hashtable", "J.modelset.LabelToken", "J.util.BS", "$.Escape", "$.Logger", "$.P3", "$.Quaternion", "$.TextFormat"], function () {
c$ = Clazz.decorateAsClass (function () {
this.monomers = null;
this.model = null;
...
this.twistedSheets = this.model.modelSet.viewer.getCartoonFlag (603979968);
...
vList.add ([points[j], J.util.P3.newP (vectors[j])]);
last = j;
} else if (last != 2147483646) {
vList.add ([points[j], J.util.P3.newP (vectors[j])]);
last = 2147483646;
}
if (last + 1 < count) vList.add ([points[last + 1], J.util.P3.newP (vectors[last + 1])]);
return last;
}, "~N,J.util.BS,java.util.List,~B,~N");
...
}, "J.modelsetbio.BioPolymer,J.util.BS,J.util.BS,java.util.List,~N,~A,~B,~B");
...
return null;
}, "J.modelset.ModelSet,J.util.BS,J.util.BS,java.util.List,~N,~N,~B");
Clazz.defineStatics (c$,
"TYPE_NOBONDING", 0,
"TYPE_AMINO", 1,
"TYPE_NUCLEIC", 2,
...
// 
Clazz.declarePackage ("J.modelsetbio");
Clazz.load (["java.lang.Enum", "J.modelsetbio.BioPolymer"], "J.modelsetbio.AlphaPolymer", ["java.util.ArrayList", "J.constant.EnumStructure", "J.modelsetbio.Helix", "$.Sheet", "$.Turn", "J.util.BS", "$.Logger", "$.Measure", "$.P3"], function () {
...
return vStruts;
}, $fz.isPrivate = true, $fz), "J.modelset.ModelSet,J.util.BS,J.util.BS,java.util.List,~N,~N,~B");
...
}, $fz.isPrivate = true, $fz), "~N,~N,~N,java.util.List,J.util.BS,J.util.BS,java.util.List,J.util.BS,J.util.BS,J.util.BS,~N");
...
// 
Clazz.declarePackage ("J.modelsetbio");
Clazz.load (["J.modelsetbio.AlphaMonomer", "J.util.P3"], "J.modelsetbio.AminoMonomer", ["J.constant.EnumStructure", "J.util.AxisAngle4f", "$.Escape", "$.Logger", "$.Matrix3f", "$.Quaternion", "$.TextFormat", "$.V3"], function () {
c$ = Clazz.decorateAsClass (function () {
...
var aminoMonomer =  new J.modelsetbio.AminoMonomer (chain, group3, seqcode, firstAtomIndex, lastAtomIndex, offsets);
return aminoMonomer;
...
case 'c':
case 'C':
return Clazz.superCall (this, J.modelsetbio.AminoMonomer, "getQuaternionFrameCenter", [qType]);
case 'n':
return this.getNitrogenAtom ();
case 'p':
case 'P':
...
break;
case 'b':
return Clazz.superCall (this, J.modelsetbio.AminoMonomer, "getQuaternion", ['b']);
case 'c':
vA.sub2 (ptC, ptCa);
...
// 
Clazz.declarePackage ("J.modelsetbio");
Clazz.load (["J.modelsetbio.AlphaPolymer"], "J.modelsetbio.AminoPolymer", ["java.lang.Boolean", "java.util.ArrayList", "$.Hashtable", "J.constant.EnumStructure", "J.i18n.GT", "J.modelset.HBond", "J.modelsetbio.APBridge", "J.util.ArrayUtil", "$.BS", "$.Escape", "$.Logger", "$.Measure", "$.P3", "$.SB", "$.TextFormat", "$.V3", "J.viewer.Viewer"], function () {
c$ = Clazz.decorateAsClass (function () {
...
}, $fz.isPrivate = true, $fz), "J.modelsetbio.AminoMonomer,J.modelsetbio.BioPolymer,~N,J.util.P3,J.util.BS,java.util.List,~A,~B");
...
vHBonds.add ( new J.modelset.HBond (nitrogen, oxygen, order, 1, 0, energy));
}, $fz.isPrivate = true, $fz), "J.modelset.Atom,J.modelset.Atom,~N,~N,~N,java.util.List");
...
}, $fz.isPrivate = true, $fz), "~A,~N,J.util.BS,~A,~B,~B,java.util.List,J.util.BS");
...
}, $fz.isPrivate = true, $fz), "~N,~A,~N,J.constant.EnumStructure,~N,J.util.BS,J.util.BS,~A,~B,~B,java.util.List,J.util.BS");
...
}, $fz.isPrivate = true, $fz), "~A,~A,java.util.List,java.util.List,java.util.Map,java.util.Map,J.util.BS,java.util.List,~A");
...
}, $fz.isPrivate = true, $fz), "~A,~N,~N,~N,~N,java.util.List,J.modelset.Atom,J.modelset.Atom,J.modelsetbio.AminoPolymer,J.modelsetbio.AminoPolymer,java.util.List,java.util.Map,~B,java.util.Map");
...
}vHBonds.add ( new J.modelset.HBond (nitrogen, oxygen, type, 1, 0, iEnergy / 1000));
}, $fz.isPrivate = true, $fz), "java.util.List,J.modelsetbio.Monomer,J.modelsetbio.Monomer,~N,~N,java.util.Map");
...
// 
Clazz.declarePackage ("J.modelsetbio");
Clazz.load (["J.modelset.Model"], "J.modelsetbio.BioModel", ["java.lang.Character", "$.Float", "java.util.ArrayList", "$.Hashtable", "J.constant.EnumStructure", "J.modelsetbio.Resolver", "J.util.ArrayUtil", "$.BS", "$.BSUtil", "$.Escape", "$.SB", "$.TextFormat", "J.viewer.Viewer"], function () {
c$ = Clazz.decorateAsClass (function () {
...
}if (bs2.nextSetBit (0) >= 0) sb.append ("select ").append (J.util.Escape.e (bs2)).append (";backbone only;");
if (this.atomCount <= maxAtoms) return;
sb.append ("select ").append (J.util.Escape.e (bs)).append (" & connected; wireframe only;");
if (bs !== this.bsAtoms) {
bs2.clearAll ();
bs2.or (this.bsAtoms);
bs2.andNot (bs);
if (bs2.nextSetBit (0) >= 0) sb.append ("select " + J.util.Escape.e (bs2) + " & !connected;stars 0.5;");
}}, "J.util.SB,~N");
...
iLastModel = iModel;
cmd.append ("  structure none ").append (J.util.Escape.e (this.modelSet.getModelAtomBitSetIncludingDeleted (iModel, false))).append (comment).append (";\n");
}comment += " & (" + res1 + " - " + res2 + ")";
var stype = subtype.getBioStructureTypeName (false);
cmd.append ("  structure ").append (stype).append (" ").append (J.util.Escape.e (bs)).append (comment).append (";\n");
} else {
var str;
var nx;
var sb;
...
return  new J.modelsetbio.CarbohydrateMonomer (chain, group3, seqcode, firstIndex, lastIndex, J.modelsetbio.CarbohydrateMonomer.alphaOffsets);
...
var nucleicMonomer =  new J.modelsetbio.NucleicMonomer (chain, group3, seqcode, firstAtomIndex, lastAtomIndex, offsets);
return nucleicMonomer;
}, "J.modelset.Chain,~S,~N,~N,~N,~A");
Clazz.makeConstructor (c$, 
function (chain, group3, seqcode, firstAtomIndex, lastAtomIndex, offsets) {
Clazz.superConstructor (this, J.modelsetbio.NucleicMonomer, [chain, group3, seqcode, firstAtomIndex, lastAtomIndex, offsets]);
...
return Clazz.superCall (this, J.modelsetbio.NucleicMonomer, "isConnectedAfter", [possiblyPreviousMonomer]);
}, "J.modelsetbio.Monomer");
Clazz.overrideMethod (c$, "findNearestAtomIndex", 
function (x, y, closest, madBegin, madEnd) {
var competitor = closest[0];
...
break;
case 'b':
return Clazz.superCall (this, J.modelsetbio.NucleicMonomer, "getQuaternion", [qType]);
case 'c':
case 'n':
ptNorP = this.getN0 ();
...
// 
Clazz.declarePackage ("J.modelsetbio");
Clazz.load (["J.modelsetbio.BioPolymer"], "J.modelsetbio.NucleicPolymer", ["J.modelset.HBond", "J.util.Measure", "$.Point4f", "$.V3"], function () {
...
vAtoms.add ( new J.modelset.HBond (atom1, atom2, 18432, 1, 0, 0));
return 1;
}, "java.util.List,J.modelset.Atom,J.modelset.Atom");
Clazz.defineMethod (c$, "getPdbData", 
function (viewer, ctype, qtype, mStep, derivType, bsAtoms, bsSelected, bothEnds, isDraw, addHeader, tokens, pdbATOM, pdbCONECT, bsWritten) {
J.modelsetbio.BioPolymer.getPdbData (viewer, this, ctype, qtype, mStep, derivType, bsAtoms, bsSelected, bothEnds, isDraw, addHeader, tokens, pdbATOM, pdbCONECT, bsWritten);
}, "J.viewer.Viewer,~S,~S,~N,~N,J.util.BS,J.util.BS,~B,~B,~B,~A,J.io.OutputStringBuilder,J.util.SB,J.util.BS");
...
function (colixes, bsSelected) {
this.isActive = true;
if (this.bsColixSet == null) this.bsColixSet =  new J.util.BS ();
for (var i = this.monomerCount; --i >= 0; ) {
var atomIndex = this.leadAtomIndices[i];
if (bsSelected.get (atomIndex)) {
colixes[i] = this.shape.getColixI (colixes[atomIndex], J.constant.EnumPalette.UNKNOWN.id, atomIndex);
if (this.colixesBack != null && this.colixesBack.length > i) this.colixesBack[i] = 0;
...
return;
}Clazz.superCall (this, J.shapebio.BioShapeCollection, "setProperty", [propertyName, value, bsSelected]);
}, "~S,~O,J.util.BS");
...
return;
}Clazz.superCall (this, J.shapebio.Backbone, "setProperty", [propertyName, value, bsSelected]);
}, "~S,~O,J.util.BS");
Clazz.overrideMethod (c$, "setShapeSizeRD", 
function (size, rd, bsSelected) {
var mad = size;
...
var mesh = this.meshes[i] =  new J.shape.Mesh ("mesh_" + this.shapeID + "_" + i, 0, i);
