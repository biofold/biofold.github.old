...
Clazz.load (null, "J.jvxl.data.JvxlCoder", ["java.lang.Character", "$.Float", "java.util.ArrayList", "J.io.XmlUtil", "J.jvxl.data.VolumeData", "J.util.BS", "$.BSUtil", "$.C", "$.Escape", "$.Logger", "$.P3", "$.Parser", "$.SB", "$.TextFormat"], function () {
...
J.io.XmlUtil.openTagAttr (data, "jvxl", ["version", "2.2", "jmolVersion", jvxlData.version, "xmlns", "http://jmol.org/jvxl_schema", "xmlns:cml", "http://www.xml-cml.org/schema"]);
...
J.io.XmlUtil.openTagAttr (sb, "jvxlSurfaceData", (vertexDataOnly || jvxlData.jvxlPlane == null ? null : jvxlData.mapLattice == null ? ["plane", J.util.Escape.e (jvxlData.jvxlPlane)] : ["plane", J.util.Escape.e (jvxlData.jvxlPlane), "maplattice", J.util.Escape.eP (jvxlData.mapLattice)]));
if (vertexDataOnly) {
...
J.jvxl.data.JvxlCoder.appendXmlColorData (sb, "jvxlColorData", jvxlData.jvxlColorData, jvxlData.isJvxlPrecisionColor, jvxlData.valueMappedToRed, jvxlData.valueMappedToBlue);
} else {
J.jvxl.data.JvxlCoder.appendXmlColorData (sb, "jvxlColorData", jvxlData.jvxlColorData, jvxlData.isJvxlPrecisionColor, jvxlData.valueMappedToRed, jvxlData.valueMappedToBlue);
...
J.io.XmlUtil.appendTagObj (sb, key, ["count", "" + n, "encoding", "base90f" + (isPrecisionColor ? "2" : "1"), "min", "" + value1, "max", "" + value2, "data", J.jvxl.data.JvxlCoder.jvxlCompressString (data, true)], null);
}, $fz.isPrivate = true, $fz), "J.util.SB,~S,~S,~B,~N,~N");
...
if (nColorData > 0) J.jvxl.data.JvxlCoder.addAttrib (attribs, "\n  colorMapped", "true");
J.jvxl.data.JvxlCoder.addAttrib (attribs, "\n  plane", J.util.Escape.e (jvxlData.jvxlPlane));
...
J.jvxl.data.JvxlCoder.addAttrib (attribs, "\n  contourValues", J.util.Escape.escapeAF (jvxlData.contourValuesUsed == null ? jvxlData.contourValues : jvxlData.contourValuesUsed));
...
J.io.XmlUtil.openTagAttr (info, "jvxlSurfaceInfo", attribs.toArray ());
...
i3 = vertexIndexes[2];
i4 = i1;
}}v.add (J.jvxl.data.JvxlCoder.getContourPoint (vertices, i1, i2, f1));
v.add (J.jvxl.data.JvxlCoder.getContourPoint (vertices, i3, i4, f2));
}
}, "java.util.List,~A,~A");
...
J.jvxl.data.JvxlCoder.appendXmlColorData (sb, "jvxlColorData", list1.appendSB (list2).append ("\n").toString (), true, jvxlData.valueMappedToRed, jvxlData.valueMappedToBlue);
}, $fz.isPrivate = true, $fz), "J.util.SB,J.jvxl.data.JvxlData,~A,~A,~A,~N,~S,~N,J.util.BS,~B,~B");
...
function (data) {
if (data.startsWith ("-")) return J.jvxl.data.JvxlCoder.jvxlDecodeBitSetRange (J.jvxl.data.JvxlCoder.jvxlUncompressString (data.substring (1)), 35, 90);
var bs =  new J.util.BS ();
var dataCount = 0;
var lastCount = 0;
var nPrev = 0;
...
}, "J.util.BS,J.util.Point4f,J.util.P3");
...
Clazz.load (["J.util.P3", "$.V3"], "J.jvxl.readers.SurfaceGenerator", ["java.io.BufferedReader", "$.StringReader", "java.lang.Float", "J.io.JmolBinary", "J.jvxl.data.JvxlCoder", "$.JvxlData", "$.MeshData", "$.VolumeData", "J.jvxl.readers.Parameters", "$.SurfaceReader", "J.util.ArrayUtil", "$.BS", "$.Escape", "$.Logger", "$.Measure", "$.Parser", "$.Point4f", "$.TextFormat"], function () {
c$ = Clazz.decorateAsClass (function () {
this.jvxlData = null;
this.meshData = null;
this.params = null;
...
if (Clazz.instanceOf (value, J.util.Point4f)) this.params.setEllipsoid (value);
...
if (this.params.isContoured) this.volumeData.setPlaneParameters (J.util.Point4f.new4 (0, 0, 1, 0));
...
// 
Clazz.declarePackage ("J.jvxl.readers");
Clazz.load (null, "J.jvxl.readers.Parameters", ["java.lang.Float", "java.util.ArrayList", "$.Hashtable", "J.util.AxisAngle4f", "$.Escape", "$.Logger", "$.Matrix3f", "$.P3", "$.Point4f", "$.V3"], function () {
c$ = Clazz.decorateAsClass (function () {
this.state = 0;
this.testFlags = 0;
...
this.setEccentricity (J.util.Point4f.new4 (0, 0, 1, 1));
this.cutoff = 1.4E-45;
this.isCutoffAbsolute = false;
...
this.contourFromZero = false;
}}, "J.jvxl.api.VertexDataServer,J.jvxl.data.VolumeData,J.util.Point4f,~A,~N,~N,~B");
...
if (this.myAtomCount == 0) {
this.setBoundingBox (J.util.P3.new3 (10, 10, 10), 0);
this.setBoundingBox (J.util.P3.new3 (-10, -10, -10), 0);
...
// 
Clazz.declarePackage ("J.jvxl.readers");
Clazz.load (["J.jvxl.readers.AtomDataReader", "J.util.P3", "$.Point4f", "$.V3"], "J.jvxl.readers.IsoSolventReader", ["java.lang.Float", "java.util.ArrayList", "$.Hashtable", "J.jvxl.data.MeshData", "J.util.BS", "$.BSUtil", "$.Logger", "$.Measure", "$.MeshSurface", "$.P3i"], function () {
c$ = Clazz.decorateAsClass (function () {
this.cavityRadius = 0;
this.envelopeRadius = 0;
this.dots = null;
...
Clazz.defineMethod (c$, "setup", 
function (isMapData) {
Clazz.superCall (this, J.jvxl.readers.IsoSolventReader, "setup", [isMapData]);
...
if (info != null) for (var i = 0; i < info.size (); i++) if ((info.get (i)[2]).booleanValue () && Clazz.instanceOf (info.get (i)[0], J.util.Point4f)) {
...
if (J.jvxl.readers.IsoSolventReader.testLinear || this.voxelSource == null || this.voxelSource[vA] == 0 || this.voxelSource[vA] != this.voxelSource[vB]) return Clazz.superCall (this, J.jvxl.readers.IsoSolventReader, "getSurfacePointAndFraction", [cutoff, isCutoffAbsolute, valueA, valueB, pointA, edgeVector, x, y, z, vA, vB, fReturn, ptReturn]);
...
Clazz.defineMethod (c$, "addVertexCopy", 
function (vertexXYZ, value, assocVertex) {
var i = Clazz.superCall (this, J.jvxl.readers.IsoSolventReader, "addVertexCopy", [vertexXYZ, value, assocVertex]);
if (i < 0) return i;
...
function () {
if (!this.havePlane) {
Clazz.superCall (this, J.jvxl.readers.IsoSolventReader, "unsetVoxelData", []);
return;
}if (this.isProgressive) for (var i = 0; i < this.yzCount; i++) {
...
this.sg.log ("draw ID \"" + label + (this.nTest++) + "\" @{point" + J.util.P3.newP (pt1) + "} @{point" + J.util.P3.newP (pt2) + "} color " + color);
}, "J.util.P3,J.util.Tuple3f,~S,~S");
...
pt.scale (d);
pt.add (pt1);
this.sg.log ("draw ID \"" + label + (this.nTest++) + "\" @{point" + J.util.P3.newP (pt1) + "} @{point" + J.util.P3.newP (pt) + "} color " + color1);
this.sg.log ("draw ID \"" + label + (this.nTest++) + "\" @{point" + J.util.P3.newP (pt) + "} @{point" + J.util.P3.newP (pt2) + "} color " + color2);
}, "J.util.P3,J.util.P3,~S,~N,~S,~S");
Clazz.defineMethod (c$, "dumpPoint", 
function (pt, label, color) {
this.sg.log ("draw ID \"" + label + (this.nTest++) + "\" @{point" + J.util.P3.newP (pt) + "} color " + color);
}, "J.util.P3,~S,~S");
...
Clazz.superCall (this, J.rendersurface.IsosurfaceRenderer, "render2", [isExport]);
